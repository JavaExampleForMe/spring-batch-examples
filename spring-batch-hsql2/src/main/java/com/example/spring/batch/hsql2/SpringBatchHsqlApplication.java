...
import com.example.spring.batch.hsql2.SpringBatchConfig;
...
public class SpringBatchHsqlApplication {
	...
	public static void main(String[] args) {
		final ConfigurableApplicationContext context = SpringApplication.run(SpringBatchHsqlApplication.class
				, args);
